...
export const translations = {
    bn: {
      ...
      project2Tech: 'JavaScript, HTML/CSS',
      project3Title: 'স্নেক গেম',
      project3Desc: 'পাইথন ব্যবহার করে তৈরি করা ক্লাসিক স্নেক গেমের একটি আধুনিক সংস্করণ।',
      project3Tech: 'Python, Pygame',
    ...
    en: {
      ...
      project3Desc: 'A modern implementation of the classic Snake game, built with Python.',
      project3Tech: 'Python, Pygame',
