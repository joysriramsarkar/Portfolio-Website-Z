...
export const translations = {
    bn: {
      ...
      project1Desc: 'বাংলা গানের একটি বিশাল ভান্ডার, যা অ্যান্ড্রয়েড এবং ওয়েব প্ল্যাটফর্মের জন্য তৈরি।',
      project1Tech: 'Node.js, TypeScript',
      project1Link: 'https://banglagan.vercel.app',
      project2Title: 'বাংলা টাইপিং টুল',
      project2Desc: 'একটি সহজ এবং দ্রুত বাংলা টাইপিং টুল যা নির্ভুলভাবে টাইপ করতে সাহায্য করে।',
      project2Tech: 'Node.js, TypeScript',
      project2Link: 'https://typingbangla.vercel.app/',
      project3Title: 'স্নেক গেম',
      project3Desc: 'টাইপস্ক্রিপ্ট ব্যবহার করে তৈরি করা ক্লাসিক স্নেক গেমের একটি আধুনিক সংস্করণ।',
      project3Tech: 'Node.js, TypeScript',
      project3Link: 'https://snakegamez.vercel.app',
      ...
      viewAllContributions: 'সকল অবদান দেখুন',
      edits: 'অবদান',
      wikiNames: { "bnwiki": "বাংলা উইকিপিডিয়া", "enwiki": "ইংরেজি উইকিপিডিয়া", "commonswiki": "উইকিমিডিয়া কমন্স", "wikidatawiki": "উইকিউপাত্ত" },
    ...
    en: {
      ...
      aboutText2: 'With a background in music (creating the Bangla Gan Database), I transitioned into tech, mastering Python, Web Development at CoderDive.',
      ...
      project1Tech: 'Node.js, TypeScript',
      project1Link: 'https://banglagan.vercel.app',
      project2Title: 'Bangla Typing Tool',
      project2Desc: 'A simple and fast tool for typing in Bengali with accuracy.',
      project2Tech: 'Node.js, TypeScript',
      project2Link: 'https://typingbangla.vercel.app/',
      project3Title: 'Snake Game',
      project3Desc: 'A modern implementation of the classic Snake game, built with TypeScript.',
      project3Tech: 'Node.js, TypeScript',
      project3Link: 'https://snakegamez.vercel.app',
      ...
      edits: 'Edits',
      wikiNames: { "bnwiki": "Bengali Wikipedia", "enwiki": "English Wikipedia", "commonswiki": "Wikimedia Commons", "wikidatawiki": "Wikidata" },
